  ...
  return (
    ...
    >
      <motion.div
        ...
        className="mb-8"
      >
        <div className="text-6xl md:text-8xl font-display font-bold mb-4 text-primary">?</div>
        <h2 className="text-3xl md:text-5xl font-display font-bold mb-4">
          You're <span className="text-primary">{result.title}</span>
        </h2>
      ...
      >
        <h3 className="text-xl font-bold mb-2">Want your full vibe breakdown?</h3>
        ...
        <div className="space-y-4">
          ...
          <Button
            ...
            size="lg"
            className="w-full bg-primary text-primary-foreground font-bold h-14 text-lg"
          >

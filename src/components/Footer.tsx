        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/quiz" className="text-muted-foreground hover:text-accent transition-colors">Find Your Vibe</Link></li>
          ...
          <div>
            ...
            <Button asChild className="bg-primary text-primary-foreground font-bold w-full">
